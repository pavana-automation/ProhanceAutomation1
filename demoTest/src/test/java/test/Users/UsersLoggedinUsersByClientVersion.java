...
public class UsersLoggedinUsersByClientVersion extends BaseTest{
	...
	public void usersLoggedinUsersByClientVersion() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		listeners.testStepDescription("Step 9: Select view By Client Version");
		...
		listeners.testStepDescription("Step 12: Get the list from web");
		hostNameList = users.getByHearbeat();
		listeners.testStepDescription("Step 13: Click on Excel export");
		users.clickByHeartbeatexcel();
		listeners.testStepDescription("Step 14: Get the list from excel");
		hostNameExcelList = excel.getByHearBeatEcxel();
		listeners.testStepDescription("Step 15: Compare the list fro web and excel are equal");
		...
		listeners.testStepDescription("Step 17: Get the list from pdf");
		String actualPdfList=  excel.getHostNameListPDFData();
		listeners.testStepDescription("Step 18: Compare the list fro web and pdf are equal");
